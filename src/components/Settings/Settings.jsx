      ...
      <div className="settings__container">
        <div className="settings__container_left">
          <div className="profile_picture_settings_container">
            <img
              className="profile_picture_settings header_profile_picture"
              src={logged_user.userpic}
              alt=""
            />
            <div className="profile_picture_settings_container_button">
              <div
                className="profile_picture_settings_container_button_div"
                onClick={UploadPhoto}
              >
                <div>
                  <img src={change_photo} alt="" />
                </div>
            ...
            <div className="settings__userdata_wrapper">
              ...
              <div className="settings__userdata_grid_container">
                <div className="settings__userdata_name">
                  ...
                  <br />
                  <input
                    className="reg_input reg_input_style"
                    type="text"
                    placeholder=""
                    name="username"
                    value={newFirstName}
                ...
                <div className="settings__userdata_userpic">
                  <label htmlFor="username">Url to profile picture</label>
                  <br />
                  <input
                    className="reg_input reg_input_style"
                    type="text"
