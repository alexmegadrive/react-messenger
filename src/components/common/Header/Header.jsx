...
const Header = ({
                    ...
                    <div className="header__wrapper">
                        ...
                        <div className="header__left-content-wrapper">
                            ...
                            <div className="header__user">
                                <img className="header__avatar-icon" src={logged_user.userpic}/>
                    ...
                    <div className="header__wrapper">
                        ...
                        <div className="header__left-content-wrapper">
                            ...
                            <div className="header__link-wrapper">
                                ...
                                <Link to="/settings" className="header__link">Настройки</Link>
                            </div>
    ...
    //
    //                 <div className="header__user">
    //                     <img className="header__avatar-icon" src={loggedUserEmail.userpic}/>
    //                     <p className="header__user-name">{loggedUserEmail.name}</p>
    //                 </div>
    //
    //                 <div className="header__link-wrapper">
    //                     <div className="header__icon-settings_gear"/>
