...
const ChatMainList = ({onSelectedChat}) => {
    ...
    const handleSelectChat = (event) => {
        ...
        const currentChat = chat_message.find(item => item.room_name === event.target.textContent);
                ...
                <div>
                    ...
                    <div className="ChatMainList_Group">
                        {chat_message.map((item, index) => {
                            return (<ChatListItem key={index} chat={item} handleSelectChat={handleSelectChat}/>)
                        })}
                    </div>
                </div>
            </div>
